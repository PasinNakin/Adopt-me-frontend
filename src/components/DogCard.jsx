    ...
    return (
        <Link to={`/profile/${dogId}`}>
            <div className="relative hover:scale-110 ease-out duration-200">
                <div
                    className={`flex items-center justify-center absolute left-0 right-0 bottom-12 mx-auto w-28 h-10 font-bold text-white text-center text-[1.2rem] rounded-2xl  ${color}`}
                >
                    {status}
                </div>
                <img
